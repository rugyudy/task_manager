...
void _taskAttach(IsarCollection<dynamic> col, Id id, Task object) {
  object.id = id;
  object.memo.attach(col, col.isar.collection<Memo>(), r'memo', id);
}
...
extension TaskQueryLinks on QueryBuilder<Task, Task, QFilterCondition> {
  QueryBuilder<Task, Task, QAfterFilterCondition> memo(FilterQuery<Memo> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'memo');
    });
  }

  QueryBuilder<Task, Task, QAfterFilterCondition> memoIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'memo', 0, true, 0, true);
    });
  }
}
